            ...
            <table class="email-layout" style="width:450px; height:300px; margin:auto; padding:0; vertical-align:middle; border-spacing:0; border-collapse:collapse;">
                ...
                <tbody class="email-body"><tr><td style="text-align:left;">
                        <div style="padding:21px 32px; background-color:#fff; border-bottom:2px solid #e1e1e1; border-radius:3px;">
                            ...
                            <p>
                                Hey,{{$adminName}}. <span>{{$userName}}</span> wants to join to group <span>{{$groupName}}</span> via Link
                            </p>
                            <p style="padding:11px 0; text-align:left;">
                                <a href="{{route('acceptGroupInvitation',['receiverEmail'=>$userEmail,'groupId'=>$groupId,'position'=>$position])}}" id="postClick" style="padding:11px 21px; text-decoration:none; color:#fff !important; background-color:forestgreen; border:1px solid #358d49; border-radius:3px;">Accept</a>
                            </p>
                            <p>
                                Cheers,<br>
                                The Bridge It Team
                ...
                <tfoot class="email-footer" style="text-align:center; font-weight:normal;"><tr><td style="padding-top:32px;">
                        <div style="color:#999;">
                            <a href="" target="_blank" style="text-decoration:none; color:#446cb3 !important;">Learning</a> |
                            <a href="" target="_blank" style="text-decoration:none; color:#446cb3 !important;">Knowledge</a> |
                            <a href="" target="_blank" style="text-decoration:none; color:#446cb3 !important;">Success</a>
                        </div>
                        <small style="font-size:12px; color:#999;">© 2024 Bridge It, all right reserved</small>
                    </td></tr></tfoot>
            </table>
