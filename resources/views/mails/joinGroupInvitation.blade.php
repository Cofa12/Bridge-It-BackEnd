            ...
            <table class="email-layout" style="width:450px; height:300px; margin:auto; padding:0; vertical-align:middle; border-spacing:0; border-collapse:collapse;">
                ...
                <tbody class="email-body"><tr><td style="text-align:left;">
                        <div style="padding:21px 32px; background-color:#fff; border-bottom:2px solid #e1e1e1; border-radius:3px;">
                            ...
                            <p>
                                Hey,Geek! <span>{{$senderName}}</span> invites you to join group <span>{{$groupName}}</span>
                            </p>
                            <p style="padding:11px 0; text-align:left;">
                                <a href="{{route('acceptGroupInvitation',['receiverEmail'=>$receiverEmail,'groupId'=>$groupId,'position'=>$position])}}" id="postClick" style="padding:11px 21px; text-decoration:none; color:#fff !important; background-color:forestgreen; border:1px solid #358d49; border-radius:3px;">Join</a>
                            </p>
                            <p>
                                Cheers,<br>
                                The Bridge It Team
